...
import NextDatePicker from '@alifd/meet-react/es/date-picker'
// import {
...
DatePicker2.WeekPicker = connect(
  NextDatePicker,
  // mapProps(mapDateFormat('week'), mapSize, mapStatus), // 无线没有周选择器
  mapProps(mapDateFormat(), mapSize, mapStatus),
  mapReadPretty(PreviewText.DatePicker)
)
...
DatePicker2.QuarterPicker = connect(
  NextDatePicker,
  // mapProps(mapDateFormat('quarter'), mapSize, mapStatus), // 无线没有quarter选择器
  mapProps(mapDateFormat(), mapSize, mapStatus),
  mapReadPretty(PreviewText.DatePicker)
)
