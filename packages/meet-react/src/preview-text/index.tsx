...
import { InputProps } from '@alifd/meet-react/es/input'
import { SelectProps } from '@alifd/meet-react/es/select'
...
} from '@alifd/meet-react/es/date-picker'
import { TimePickerProps } from '@alifd/meet-react/es/time-picker'
// import { Tag } from '@alifd/next'
import Tag from '@alifd/meet-react/es/tag'
...
const Select: React.FC<SelectProps> = observer((props) => {
  ...
  const getSelected = () => {
    ...
    if (props.mode === 'multiple' || props.displayType === 'tag') {
